...
SELECT id_Comuna, Nmbre_comuna, cod_comuna, codi_region FROM Comunas WHERE (id_Comuna = @id_Comuna)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT id_Comuna, Nmbre_comuna, cod_comuna, codi_region FROM dbo.Comunas";
        ...
        public virtual int FillBy(CAR_MANAGERDataSet1.ComunasDataTable dataTable) {
